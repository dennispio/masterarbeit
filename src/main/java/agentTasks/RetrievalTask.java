	...
	try {		
		...
		if(!(ph.getName().equals("undefined"))){					
			...
			if(soccerplayer.getInstance(ph.getName()).getAttForDesc(overallAbgefangeneBaelleDesc).getValueAsString() != "_unknown_") {
				query.addAttribute(overallAbgefangeneBaelleDesc, overallAbgefangeneBaelleDesc.getAttribute(
						Float.parseFloat(soccerplayer.getInstance(ph.getName()).getAttForDesc(overallAbgefangeneBaelleDesc).getValueAsString())));
			};
			if(soccerplayer.getInstance(ph.getName()).getAttForDesc(overallAssistsDesc).getValueAsString() != "_unknown_") {
				query.addAttribute(overallAssistsDesc, overallAssistsDesc.getAttribute(
						Integer.parseInt(soccerplayer.getInstance(ph.getName()).getAttForDesc(overallAssistsDesc).getValueAsString())));
			};
			if(soccerplayer.getInstance(ph.getName()).getAttForDesc(overallBallEroberungenDesc).getValueAsString() != "_unknown_") {
				query.addAttribute(overallBallEroberungenDesc, overallBallEroberungenDesc.getAttribute(
						Float.parseFloat(soccerplayer.getInstance(ph.getName()).getAttForDesc(overallBallEroberungenDesc).getValueAsString())));
			};
			if(soccerplayer.getInstance(ph.getName()).getAttForDesc(overallBallverlustDesc).getValueAsString() != "_unknown_") {
				query.addAttribute(overallBallverlustDesc, overallBallverlustDesc.getAttribute(
						Float.parseFloat(soccerplayer.getInstance(ph.getName()).getAttForDesc(overallBallverlustDesc).getValueAsString())));
			};
			...
			if(soccerplayer.getInstance(ph.getName()).getAttForDesc(overallDribblingsDesc).getValueAsString() != "_unknown_") {
				query.addAttribute(overallDribblingsDesc, overallDribblingsDesc.getAttribute(
						Float.parseFloat(soccerplayer.getInstance(ph.getName()).getAttForDesc(overallDribblingsDesc).getValueAsString())));
			};
			if(soccerplayer.getInstance(ph.getName()).getAttForDesc(overallEinsatzquoteDesc).getValueAsString() != "_unknown_") {
				query.addAttribute(overallEinsatzquoteDesc, overallEinsatzquoteDesc.getAttribute(
						Float.parseFloat(soccerplayer.getInstance(ph.getName()).getAttForDesc(overallEinsatzquoteDesc).getValueAsString())));
			};
			if(soccerplayer.getInstance(ph.getName()).getAttForDesc(overallFoulsDesc).getValueAsString() != "_unknown_") {
				query.addAttribute(overallFoulsDesc, overallFoulsDesc.getAttribute(
						Float.parseFloat(soccerplayer.getInstance(ph.getName()).getAttForDesc(overallFoulsDesc).getValueAsString())));
			};
			...
			if(soccerplayer.getInstance(ph.getName()).getAttForDesc(overallGoalsDesc).getValueAsString() != "_unknown_") {
				query.addAttribute(overallGoalsDesc, overallGoalsDesc.getAttribute(
						Integer.parseInt(soccerplayer.getInstance(ph.getName()).getAttForDesc(overallGoalsDesc).getValueAsString())));
			};
			if(soccerplayer.getInstance(ph.getName()).getAttForDesc(overallKP90Desc).getValueAsString() != "_unknown_") {
				query.addAttribute(overallKP90Desc, overallKP90Desc.getAttribute(
						Float.parseFloat(soccerplayer.getInstance(ph.getName()).getAttForDesc(overallKP90Desc).getValueAsString())));
			};
			...
			if(soccerplayer.getInstance(ph.getName()).getAttForDesc(overallMinPlayedDesc).getValueAsString() != "_unknown_") {
				query.addAttribute(overallMinPlayedDesc, overallMinPlayedDesc.getAttribute(
						Integer.parseInt(soccerplayer.getInstance(ph.getName()).getAttForDesc(overallMinPlayedDesc).getValueAsString())));
			};
			if(soccerplayer.getInstance(ph.getName()).getAttForDesc(overallPassquoteDesc).getValueAsString() != "_unknown_") {
				query.addAttribute(overallPassquoteDesc, overallPassquoteDesc.getAttribute(
						Float.parseFloat(soccerplayer.getInstance(ph.getName()).getAttForDesc(overallPassquoteDesc).getValueAsString())));
			};
			...
			if(soccerplayer.getInstance(ph.getName()).getAttForDesc(overallSH90Desc).getValueAsString() != "_unknown_") {
				query.addAttribute(overallSH90Desc, overallSH90Desc.getAttribute(
						Float.parseFloat(soccerplayer.getInstance(ph.getName()).getAttForDesc(overallSH90Desc).getValueAsString())));
			};
			if(soccerplayer.getInstance(ph.getName()).getAttForDesc(overallTacklingquoteDesc).getValueAsString() != "_unknown_") {
				query.addAttribute(overallTacklingquoteDesc, overallTacklingquoteDesc.getAttribute(
						Float.parseFloat(soccerplayer.getInstance(ph.getName()).getAttForDesc(overallTacklingquoteDesc).getValueAsString())));
			};
			if(soccerplayer.getInstance(ph.getName()).getAttForDesc(overallZweikampfquoteDesc).getValueAsString() != "_unknown_") {
				query.addAttribute(overallZweikampfquoteDesc, overallZweikampfquoteDesc.getAttribute(
						Float.parseFloat(soccerplayer.getInstance(ph.getName()).getAttForDesc(overallZweikampfquoteDesc).getValueAsString())));
			};
			if(soccerplayer.getInstance(ph.getName()).getAttForDesc(overallxADesc).getValueAsString() != "_unknown_") {
				query.addAttribute(overallxADesc, overallxADesc.getAttribute(
						Float.parseFloat(soccerplayer.getInstance(ph.getName()).getAttForDesc(overallxADesc).getValueAsString())));
			};
			if(soccerplayer.getInstance(ph.getName()).getAttForDesc(overallxA90Desc).getValueAsString() != "_unknown_") {
				query.addAttribute(overallxA90Desc, overallxA90Desc.getAttribute(
						Float.parseFloat(soccerplayer.getInstance(ph.getName()).getAttForDesc(overallxA90Desc).getValueAsString())));
			};
			if(soccerplayer.getInstance(ph.getName()).getAttForDesc(overallxGDesc).getValueAsString() != "_unknown_") {
				query.addAttribute(overallxGDesc, overallxGDesc.getAttribute(
						Float.parseFloat(soccerplayer.getInstance(ph.getName()).getAttForDesc(overallxGDesc).getValueAsString())));
			};
			if(soccerplayer.getInstance(ph.getName()).getAttForDesc(overallxG90Desc).getValueAsString() != "_unknown_") {
				query.addAttribute(overallxG90Desc, overallxG90Desc.getAttribute(
						Float.parseFloat(soccerplayer.getInstance(ph.getName()).getAttForDesc(overallxG90Desc).getValueAsString())));
			};
			if(soccerplayer.getInstance(ph.getName()).getAttForDesc(overallTorschussVorlagen).getValueAsString() != "_unknown_") {
				query.addAttribute(overallTorschussVorlagen, overallTorschussVorlagen.getAttribute(
						Float.parseFloat(soccerplayer.getInstance(ph.getName()).getAttForDesc(overallTorschussVorlagen).getValueAsString())));
			};
			...
			if(soccerplayer.getInstance(ph.getName()).getAttForDesc(overallTorschuesseDesc).getValueAsString() != "_unknown_") {
				query.addAttribute(overallTorschuesseDesc, overallTorschuesseDesc.getAttribute(
						Float.parseFloat(soccerplayer.getInstance(ph.getName()).getAttForDesc(overallTorschuesseDesc).getValueAsString())));
			};
			if(soccerplayer.getInstance(ph.getName()).getAttForDesc(overallLuftzweikampfDesc).getValueAsString() != "_unknown_") {
				query.addAttribute(overallLuftzweikampfDesc, overallLuftzweikampfDesc.getAttribute(
						Float.parseFloat(soccerplayer.getInstance(ph.getName()).getAttForDesc(overallLuftzweikampfDesc).getValueAsString())));
			};
			if(soccerplayer.getInstance(ph.getName()).getAttForDesc(transfermarktwertDesc).getValueAsString() != "_unknown_") {
				query.addAttribute(transfermarktwertDesc, transfermarktwertDesc.getAttribute(
						Float.parseFloat(soccerplayer.getInstance(ph.getName()).getAttForDesc(transfermarktwertDesc).getValueAsString())));
				};
			...
			switch(ph.getSpielertyp()){
				...
				case "defensiv": 		
			    	...
			    	soccerplayer.getActiveAmalgamFct().setWeight(overallkreierteGrosschancenDesc, 0);
			    	soccerplayer.getActiveAmalgamFct().setWeight(overallMinPlayedDesc, 1);
			    	soccerplayer.getActiveAmalgamFct().setWeight(overallPassquoteDesc, 1);
			    	soccerplayer.getActiveAmalgamFct().setWeight(overallSchussgenauigkeitDesc, 0);
			    	soccerplayer.getActiveAmalgamFct().setWeight(overallSH90Desc, 0);
			    	soccerplayer.getActiveAmalgamFct().setWeight(overallTacklingquoteDesc, 1);
			    	soccerplayer.getActiveAmalgamFct().setWeight(overallZweikampfquoteDesc, 1);
			    	soccerplayer.getActiveAmalgamFct().setWeight(overallxADesc, 0);
			    	soccerplayer.getActiveAmalgamFct().setWeight(overallxA90Desc, 0);
			    	soccerplayer.getActiveAmalgamFct().setWeight(overallxGDesc, 0);
			    	soccerplayer.getActiveAmalgamFct().setWeight(overallxG90Desc, 0);
				...
				case "offensiv": 
			    	...
			    	soccerplayer.getActiveAmalgamFct().setWeight(overallZweikampfquoteDesc, 0);
			    	soccerplayer.getActiveAmalgamFct().setWeight(overallxADesc, 1);
			    	soccerplayer.getActiveAmalgamFct().setWeight(overallxA90Desc, 1);
			    	soccerplayer.getActiveAmalgamFct().setWeight(overallxGDesc, 1);
			    	soccerplayer.getActiveAmalgamFct().setWeight(overallxG90Desc, 1);
...
//			    	soccerplayer.getActiveAmalgamFct().setWeight(overallBallEroberungenDesc, 0);
//			    	soccerplayer.getActiveAmalgamFct().setWeight(overallBallverlustDesc, 0);
//			    	soccerplayer.getActiveAmalgamFct().setWeight(overallBewertungDesc, 0);
//			    	soccerplayer.getActiveAmalgamFct().setWeight(overallBlockSchussDesc, 0);
//			    	soccerplayer.getActiveAmalgamFct().setWeight(overallDribblingsDesc, 0);
...
//			    	soccerplayer.getActiveAmalgamFct().setWeight(positionDesc, 0);
			    	System.out.println("bin in offensiv");
	    	...
	    	query.addAttribute(overallAbgefangeneBaelleDesc, overallAbgefangeneBaelleDesc
	    			.getAttribute(Float.parseFloat(ph.getOverallAbgefangeneBaelle())));
	    	query.addAttribute(overallAssistsDesc, overallAssistsDesc
	    			.getAttribute(Integer.parseInt(ph.getOverllAssists())));
	    	query.addAttribute(overallBallEroberungenDesc, overallBallEroberungenDesc
	    			.getAttribute(Float.parseFloat(ph.getOverallBallEroberungen())));
	    	query.addAttribute(overallBallverlustDesc, overallBallverlustDesc
	    			.getAttribute(Float.parseFloat(ph.getOverallBallverlust())));
	    	query.addAttribute(overallBewertungDesc, overallBewertungDesc
	    			.getAttribute(Float.parseFloat(ph.getOverallBewertung())));
	    	query.addAttribute(overallBlockSchussDesc, overallBlockSchussDesc
	    			.getAttribute(Float.parseFloat(ph.getOverallBlockSchuss())));
	    	query.addAttribute(overallDribblingsDesc, overallDribblingsDesc
	    			.getAttribute(Float.parseFloat(ph.getOverallDribblings())));
	    	query.addAttribute(overallEinsatzquoteDesc, overallEinsatzquoteDesc
	    			.getAttribute(Float.parseFloat(ph.getOverallEinsatzquote())));
	    	query.addAttribute(overallFoulsDesc, overallFoulsDesc
	    			.getAttribute(Float.parseFloat(ph.getOverallFouls())));
	    	query.addAttribute(overallGeklaerteBaelleDesc, overallGeklaerteBaelleDesc
	    			.getAttribute(Float.parseFloat(ph.getOverallGeklaerteBaelle())));
	    	query.addAttribute(overallGoalsDesc, overallGoalsDesc
	    			.getAttribute(Integer.parseInt(ph.getOverallGoals())));
	    	query.addAttribute(overallKP90Desc, overallKP90Desc
	    			.getAttribute(Float.parseFloat(ph.getOverallKPNEUN())));
	    	query.addAttribute(overallkreierteGrosschancenDesc, overallkreierteGrosschancenDesc
	    			.getAttribute(Float.parseFloat(ph.getOverallkreierteGrosschancen())));
	    	query.addAttribute(overallPassquoteDesc, overallPassquoteDesc
	    			.getAttribute(Float.parseFloat(ph.getOverallPassquote())));
	    	query.addAttribute(overallSchussgenauigkeitDesc, overallSchussgenauigkeitDesc
	    			.getAttribute(Float.parseFloat(ph.getOverallSchussgenauigkeit())));
	    	query.addAttribute(overallSH90Desc, overallSH90Desc
	    			.getAttribute(Float.parseFloat(ph.getOverallSHNeun())));
	    	query.addAttribute(overallTacklingquoteDesc, overallTacklingquoteDesc
	    			.getAttribute(Float.parseFloat(ph.getOverallTacklingQuote())));
	    	query.addAttribute(overallZweikampfquoteDesc, overallZweikampfquoteDesc
	    			.getAttribute(Float.parseFloat(ph.getOverallZweikampfquote())));
	    	query.addAttribute(overallxADesc, overallxADesc
	    			.getAttribute(Float.parseFloat(ph.getOverallxA())));
	    	query.addAttribute(overallxA90Desc, overallxA90Desc
	    			.getAttribute(Float.parseFloat(ph.getOverallxANEUN())));
	    	query.addAttribute(overallxGDesc, overallxGDesc
	    			.getAttribute(Float.parseFloat(ph.getOverallxG())));
	    	query.addAttribute(overallxG90Desc, overallxG90Desc
	    			.getAttribute(Float.parseFloat(ph.getOverallxGNEUN())));
	    	query.addAttribute(overallTorschussVorlagen, overallTorschussVorlagen
	    			.getAttribute(Float.parseFloat(ph.getOverallTorschussVorlagen())));
	    	query.addAttribute(positionDesc, positionDesc
	    			.getAttribute(ph.getPosition()));
	    	query.addAttribute(overallTorschuesseDesc, overallTorschuesseDesc
	    			.getAttribute(Float.parseFloat(ph.getOverallTorschuesse())));
	    	query.addAttribute(overallLuftzweikampfDesc, overallLuftzweikampfDesc
	    			.getAttribute(Float.parseFloat(ph.getOverallLuftzweikampf())));
	    	query.addAttribute(transfermarktwertDesc, transfermarktwertDesc
	    			.getAttribute(Float.parseFloat(ph.getTransfermarktwert())));
