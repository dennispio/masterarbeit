...
public class Phone {
	 ...
	 * @param nfc
	 */
	public Phone(String manufacture, String model, String resolution, String price, String weight, String size,
	...
	public Phone(String manufacture, String price, String weight, String size,
			String displaytype, String cpu, String ram, String akkukapa, String kameraMegapixel,
			String frontkameraMegapixel, String memoryslot, String memory, String nfc, String thickness) {
		this.manufacture = manufacture;
		this.price = price;
